(function(
    ...
    has.add("host-worker", userConfig.has && "host-worker" in userConfig.has ?
        userConfig.has["host-worker"] :
        (typeof importScripts == "function" && !!self));
    if(has("host-worker")){
        // fixup the default config for node.js environment
        importScripts(userConfig.baseUrl  + "/_base/configWebWorker.js");
        webWorkerConfig(defaultConfig);
    }
